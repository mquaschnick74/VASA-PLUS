  ...
  return (
    <div className={cn("relative", className)}>
      ...
      >
        ...
        <CollapsibleContent className="absolute z-40 mt-2 right-0 w-[90vw] sm:w-96 max-w-[calc(100vw-2rem)]">
          <div className="bg-red-950/90 backdrop-blur-xl border border-red-500/30 rounded-lg p-3 sm:p-4 shadow-2xl mr-4 sm:mr-0">
            {/* Header */}
            <div className="flex items-center gap-2 mb-3">
              <AlertTriangle className="w-4 h-4 sm:w-5 sm:h-5 text-red-500 flex-shrink-0" />
              <h3 className="text-xs sm:text-sm font-semibold text-white">AI Therapy Limitations</h3>
            </div>
            ...
            <div className="space-y-2 sm:space-y-3 text-[11px] sm:text-xs text-white/80">
              ...
              <div className="bg-red-500/20 border border-red-500/40 rounded p-2">
                <p className="text-white/90 font-medium text-[11px] sm:text-xs mb-1 flex items-center gap-1">
              ...
              {/* Footer */}
              <p className="text-[9px] sm:text-[10px] text-white/60 italic pt-2 border-t border-white/10">
                By using iVASA, you acknowledge this service is not a substitute for professional medical advice, diagnosis, or treatment.
              </p>
            </div>
          </div>
        </CollapsibleContent>
