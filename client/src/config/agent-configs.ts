...
// ═══════════════════════════════════════════════════════════════════════════════
// NOTE: UNA (Unary Narrative Architecture) agent configuration has been moved to:
// ./una/una-agent-config.ts
// UNA uses a fundamentally different therapeutic approach from VASA/CSS/PCA
// ═══════════════════════════════════════════════════════════════════════════════
...
${VASA_SYSTEM_PROMPT}`,
  ...
  // NOTE: UNA agent is defined in ./una/una-agent-config.ts
  // Use ALL_AGENTS from ./index.ts to include UNA
];
